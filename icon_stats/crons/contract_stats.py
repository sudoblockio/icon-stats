...
async def run_contract_stats():
    ...
    for c in await Contract.get_all():
        ...
        #
        c.unique_addresses_24h = await get_unique_addresses(c.address, timestamps[1])
        c.unique_addresses_7d = await get_unique_addresses(c.address, timestamps[7])
        c.unique_addresses_30d = await get_unique_addresses(c.address, timestamps[30])
