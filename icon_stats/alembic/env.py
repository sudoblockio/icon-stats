...
from icon_stats.db_async import ASYNC_SQLALCHEMY_DATABASE_URL
...
#     # connection.execute(text("SET search_path TO stats"))
#
#     with context.begin_transaction():
#         context.run_migrations()
...
async def run_async_migrations() -> None:
    ...
    async with connectable.connect() as connection:
        ...
        # await connection.execute(text("SET search_path TO stats"))
